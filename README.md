...
- Built interactive charts including Combo, Waterfall, Pie, Bar, and Map Charts.
- Added KPI cards to monitor Sales, Profit, Orders, Quantity, and YoY Growth.
- Connected all Pivot Tables and Charts using Slicers.
- Designed an interactive dashboard for business analysis and decision-making.
...
- Office Supplies contributed significantly to total sales.
- Binders and Phones were among the top-performing sub-categories.
- Sales varied across different states and regions.
- Interactive slicers allow dynamic dashboard analysis.
